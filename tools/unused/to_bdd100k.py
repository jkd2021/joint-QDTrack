...
from pcan.core.to_bdd100k import preds2bdd100k


def parse_args():
    parser = argparse.ArgumentParser(description='pcan test model')
    parser.add_argument('--config', default='../configs/SEGTRK_segtrack-frcnn_r50_fpn_12e_bdd10k.py', help='test config file path')
    parser.add_argument('--res', default='../vis_pcan_result_test/BDD_val_mAP/0817_bdd_epo_12/eval_github_cfg_epo_12.pkl', help='output result file')
    parser.add_argument(
        '--bdd-dir',
        default='../vis_pcan_result_test/BDD_val_mAP/0817_bdd_epo_12/bdd',
        type=str,
