...
class JointEMQuasiDenseMaskRCNNRefine(JointMaskQuasiDenseMaskRCNN):  # PCAN joint model (not developed)
    ...
    def fix_modules(self):
        fixed_modules = [
            ...
            # self.roi_head.amodal_mask_roi_extractor,
            # self.roi_head.amodal_mask_head
        ]
