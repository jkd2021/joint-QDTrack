_base_ = './BDD_qdtrack-frcnn_r50_fpn_12e_bdd100k.py'
# model settings
model = dict(
...
data_root = 'D:/Pycharm_Programms_New/PCAN/pcan/data/bdd/'
...
evaluation = dict(metric=["bbox", "segm", 'track', 'segtrack'], interval=12)
