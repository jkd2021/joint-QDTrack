...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_head=dict(loss_cls=dict(loss_weight=1.0), loss_bbox=dict(loss_weight=1.0)),  # visible_bbox_head cls/bbox loss
        ...
        mask_head=dict(
            ...
            num_classes=24,
            loss_mask=dict(
                type='CrossEntropyLoss', use_mask=True, loss_weight=1.5)),                # visible_mask_head loss
        ...
        amodal_mask_head=dict(
            ...
            loss_amodal_mask=dict(
                type='CrossEntropyLoss', use_mask=True, loss_weight=0.5))),               # amodal_mask_head loss
...
data = dict(
    ...
    train=[
        dict(
            ...
            # QDTrack-mots-joint+ joint training on SAIL-VOScut (amo+vis bbox, amo+vis mask)
            ann_file="/beegfs/work/shared/kangdong_shared/sailvos_cut_json/png_joint/new_train_less0.75_png_joint(bbox=both_bbox).json",
            img_prefix='/beegfs/work/shared/kangdong_shared/sailvos_cut_png/',
            
            # # QDTrack-mots-joint+ joint training on SAIL-VOS (amo+vis bbox, amo+vis mask) (contains abrupt scene change)
            # ann_file="/beegfs/work/shared/kangdong_shared/sailvos_complete_json/png_joint_cmplt_video/cmplt_video_new_train_less0.75_png_joint(bbox=both_bbox).json",
    ...
    val=dict(
        ...
        # QDTrack-mots-joint+ joint validation on SAIL-VOScut (amo+vis bbox, amo+vis mask)
        ann_file="/beegfs/work/shared/kangdong_shared/sailvos_cut_json/png_joint/new_valid_less0.75_png_joint(bbox=both_bbox).json",
        img_prefix='/beegfs/work/shared/kangdong_shared/sailvos_cut_png/',


        # # QDTrack-mots-joint+ joint validation on SAIL-VOS (amo+vis bbox, amo+vis mask)
        # ann_file="/beegfs/work/shared/kangdong_shared/sailvos_complete_json/png_joint_cmplt_video/cmplt_video_new_valid_less0.75_png_joint(bbox=both_bbox).json",
        # img_prefix='/beegfs/work/shared/kangdong_shared/sailvos_complete_video/',
    ...
    test=dict(
        ...
        # QDTrack-mots-joint+ joint testing on SAIL-VOScut (amo+vis bbox, amo+vis mask)
        ann_file="/beegfs/work/shared/kangdong_shared/sailvos_cut_json/png_joint/new_valid_less0.75_png_joint(bbox=both_bbox).json",
        img_prefix='/beegfs/work/shared/kangdong_shared/sailvos_cut_png/',

        # # QDTrack-mots-joint+ joint testing on SAIL-VOS (amo+vis bbox, amo+vis mask)
        # ann_file="/beegfs/work/shared/kangdong_shared/sailvos_complete_json/png_joint_cmplt_video/cmplt_video_new_valid_less0.75_png_joint(bbox=both_bbox).json",
        # img_prefix='/beegfs/work/shared/kangdong_shared/sailvos_complete_video/',
...
# optimizer = dict(                                                         # AdamW could be further implemented
...
gpu_ids = [0]
# load_from = '/beegfs/work/shared/kangdong_shared/ckpts/resnet50.pth'
load_from = '/beegfs/work/shared/kangdong_shared/ckpts/resnext101_64_4d.pth'
resume_from = None
